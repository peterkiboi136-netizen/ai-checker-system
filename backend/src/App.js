    ...
    <div style={{ padding: "40px", fontFamily: "Arial" }}>
      ...
      {result && (
        ...
        <div style={{ marginTop: "30px" }}>
          ...
          <p>
            <strong>AI Score:</strong> {result.analysis.ai_score}
          </p>

          <p>
            <strong>Risk Level:</strong> {result.analysis.risk_level}
          </p>
          ...
          <p>
            <strong>Sentence Count:</strong> {result.analysis.sentence_count}
          </p>

          <p>
            <strong>Report:</strong> {result.report_url}
          </p>
